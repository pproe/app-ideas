...
|:-:| ----------------------------------------------------------------------------- | ---------------------------------------------------------- | ---------- |
|✅| [Bin2Dec](https://github.com/pproe/bin2dec)                                | Binary-to-Decimal number converter                         | 1-Beginner |
...
|🚧| [Countdown Timer](https://github.com/pproe/countdowntimer)                   | Event Countdown timer                                      | 1-Beginner |
